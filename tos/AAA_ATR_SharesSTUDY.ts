...
plot SharesX = risk_shares_x;
plot SharesL = if risk_shares_x != risk_shares_l then risk_shares_l else Double.NaN;

SharesX. setDefaultColor(Color.RED);
SharesL. setDefaultColor(Color.GREEN);
